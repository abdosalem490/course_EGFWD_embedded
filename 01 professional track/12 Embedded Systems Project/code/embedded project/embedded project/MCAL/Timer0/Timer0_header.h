...
// struct to hold timer information
typedef struct Timer0_t{
	uint8_t args_timer0_initValue;
	uint8_t args_u8timer0_mode;
	uint32_t args_u32TimeInMilliSeconds;
	void (*args_pvCallBackFunc)(void);
	void (*args_pvCallBackOutCmp)(void);
	void (*args_pvCallBackFuncOverflow)(void);
	uint8_t args_u8ClockSelect;
	uint8_t args_u8tOCRVal;
	uint8_t args_u8timer0_outpin_mode;
}Timer0_t;
